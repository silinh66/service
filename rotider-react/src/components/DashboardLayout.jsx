...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <div className="dashboard-container">
            ...
            {/* Sidebar */}
            <div className={`dashboard-sidebar ${isMobileMenuOpen ? 'sidebar-open' : ''}`}>
                <div className="px-10 py-3 border-b border-solid border-gray-200">
                    <Link to="/">
                ...
                <div className="p-5 flex-grow overflow-y-auto">
                    <div className="mt-4">
                        ...
                        <div className="flex flex-col gap-y-1">
                            <Link
                                className={`px-5 py-3 space-x-3 rounded-lg text-sm flex items-center ${isActive('/my-order') ? 'bg-gray-200' : 'hover:bg-gray-100'}`}
                                to="/my-order"
                                onClick={() => setIsMobileMenuOpen(false)}
                            >
                                <svg
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex flex-col gap-y-1">
                            <Link
                                className={`px-5 py-3 space-x-3 rounded-lg text-sm flex items-center ${isActive('/my-account') ? 'bg-gray-200' : 'hover:bg-gray-100'}`}
                                to="/my-account"
                                onClick={() => setIsMobileMenuOpen(false)}
                            >
                                <svg
            ...
            <main className="flex-grow flex flex-col h-screen overflow-hidden">
                {/* Header */}
                <div className="h-[75px] p-3 pl-6 pr-10 border-b border-solid border-gray-200 w-full flex items-center justify-between lg:justify-end flex-shrink-0 header-content">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                        data-icon="bars"
                        className="svg-inline--fa fa-bars hamburger-btn"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512"
