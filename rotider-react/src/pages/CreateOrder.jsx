...
const CreateOrder = () => {
  ...
  return (
    <div className="h-screen flex">
      {/* Sidebar */}
      <div className="w-[250px] bg-gray-50 flex-shrink-0 flex flex-col border-r border-gray-200">
        <div className="px-10 py-3 border-b border-gray-200">
          <img
            alt="ZOOZOO logo with dark color"
            className="h-[50px]"
            src={
        ...
        <div className="p-5 flex-grow overflow-y-auto">
          <div className="mt-4">
            ...
            <div className="flex flex-col gap-y-1">
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm hover:bg-gray-200 flex items-center"
                href="https://orders.ZOOZOO.com/my-account"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  data-icon="receipt"
                  className="svg-inline--fa fa-receipt fa-fw text-primary-dark w-5 h-4"
                  role="img"
              ...
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm bg-gray-300 flex items-center"
                href="#"
              >
                <svg
                  aria-hidden="true"
                  ...
                  className="svg-inline--fa fa-cart-shopping fa-fw text-black w-5 h-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 576 512"
                >
              ...
              >
                <svg
                  ...
                  className="svg-inline--fa fa-comment-dots fa-fw text-primary-dark w-5 h-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
              ...
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm hover:bg-gray-200 flex items-center"
                href="https://orders.ZOOZOO.com/my-account/support-chat"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm hover:bg-gray-200 flex items-center"
                href="https://orders.ZOOZOO.com/my-account/payment"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  data-icon="wallet"
                  className="svg-inline--fa fa-wallet fa-fw text-primary-dark w-5 h-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-col gap-y-1">
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm hover:bg-gray-200 flex items-center"
                href="https://orders.ZOOZOO.com/my-account/profile"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  data-icon="user"
                  className="svg-inline--fa fa-user fa-fw text-primary-dark w-5 h-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                >
              ...
              <a
                className="px-5 py-3 space-x-3 rounded-lg text-sm hover:bg-gray-200 flex items-center"
                href="https://orders.ZOOZOO.com/my-account/change-password"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  data-icon="lock"
                  className="svg-inline--fa fa-lock fa-fw text-primary-dark w-5 h-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                >
      ...
      <main className="flex-grow flex flex-col">
        {/* Header */}
        <div className="h-[75px] p-3 pl-6 pr-10 border-b border-gray-200 w-full flex items-center justify-between md:justify-end">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
